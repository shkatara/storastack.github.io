...
<br>
<textarea rows="15"  name="code" form="usrform" placeholder=" Enter your C code here" class="textarea1"></textarea>

<form action="c_compile.php" id="usrform" method="post" target="my_iframe">
	...
	<div class="out">
	 <iframe class="iframe1" width="100%" src="c_compile.php" name="my_iframe"></iframe> 
	</div>
<div class="footer1">
