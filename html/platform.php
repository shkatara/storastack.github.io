...
<body>
	...
	<div class="outer">
		...
		<div class="menu">
			...
			<ul>	
				<a href="python.php"><li class="python">Python</li></a>
				<a href="go.php"><li class="go">Go</li></a>
				<a href="python.php"><li class="python">Scala</li></a>
				<a href="go.php"><li class="go">Apex</li></a>
				<a href="python.php"><li class="python">Objective C</li></a>
				<a href="go.php"><li class="go">Perl</li></a>
