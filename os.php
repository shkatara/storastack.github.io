...
<html>
   <head>
      ...
      <title>SToraSTack 2.0 - Create Infrastructure </title>
   ...
   <div class="head">
      <div class="login">
         <form method="post" action="os_create.php">
            ...
            <p class="label">Select OS Type</p>
            <select name="type">
               <option value="linux">Linux</option>
               <option value="ubuntu">Ubuntu</option>
               <option value="windows">Windows</option>
            </select>
            <p class="label">Select OS Variant</p>
            <select name="variant">
               <option value="rhel7">Redhat 7.2</option>
               <option value="rhel6">Redhat 6.4</option>
               <option value="ubuntu">Ubuntu 11.04</option>
            </select>
            <p class="label">Select CPU Cores</p>
            <select name="cpu">
